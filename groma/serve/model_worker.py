...
from groma.constants import WORKER_HEART_BEAT_INTERVAL
from groma.utils import (build_logger, server_error_msg,
                         pretty_print_semaphore)
from groma.model import *
...
class ModelWorker:
    def __init__(self, controller_addr, worker_addr,
        ...
        self.is_multimodal = 'groma' in model_path.lower()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--multi-modal", action="store_true", help="Multimodal mode is automatically detected with model name, please make sure `groma` is included in the model path.")
    ...
    if args.multi_modal:
        logger.warning("Multimodal mode is automatically detected with model name, please make sure `groma` is included in the model path.")
